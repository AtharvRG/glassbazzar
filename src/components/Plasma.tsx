...
void mainImage(out vec4 o, vec2 C) {
  ...
  for (vec2 r = iResolution.xy, Q = vec2(0.0); ++i < 60.; O += o.w/d*o.xyz) {
...
export const Plasma: React.FC<PlasmaProps> = ({
    ...
    useLayoutEffect(() => {
        ...
        // Extra trigger for re-mounts
        const resizeInterval = setInterval(setSize, 500);
    ...
    return <div ref={containerRef} className="w-full h-full relative overflow-hidden pointer-events-none" style={{ zIndex: -1 }} />;
};
